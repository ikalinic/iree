...
// hipStatus_t return value to an iree_status_t.
//
// Usage:
//   IREE_ROCM_RETURN_AND_END_ZONE_IF_ERROR(zone_id, rocm_symbols,
//                                          hipDoThing(...), "message");
#define IREE_ROCM_RETURN_AND_END_ZONE_IF_ERROR(zone_id, syms, expr, ...) \
