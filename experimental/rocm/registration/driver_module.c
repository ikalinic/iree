...
IREE_FLAG(bool, rocm_use_streams, true,
          "Use ROCM streams for executing command buffers (instead of graphs).");

IREE_FLAG(bool, rocm_use_direct, false,
          "Use ROCM direct for executing command buffers (instead of graphs or streams).");
